        ...
        <el-collapse-item name="2">
          ...
          <div class="baogao">
            ...
            <div class="types">
              <div class="type">
                <span>病理类型:</span>
                <el-select v-model="edit.diagnosis1_Ynormal" size="mini" style="width:180px" @change="shaixuan()" filterable placeholder="请输入或选择病理类型">
              ...
              <div class="type">
                <span>病理亚型：</span>
                <el-select v-model="edit.diagnosis3_Ynormal" size="mini" style="width:480px" @change="shaixuan()" filterable placeholder="请输入或选择病理亚型">
              ...
              <div class="type">
                <span>级别:</span>
                <el-select v-model="edit.Ylevel" size="mini" style="width:100px" @change="shaixuan()">
        ...
        <el-collapse-item name="3">
          ...
          <div class="zhenduan">
            ...
            <div class="types">
              <div class="type">
                <span>病理类型:</span>
                <el-select v-model="edit.diagnosis1_normal" size="mini" style="width:180px" @change="shaixuan()" filterable placeholder="请输入或选择病理类型">
                  <el-option v-for="(item,index) in  this.onechoose" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
              ...
              <div class="type">
                <span>病理亚型：</span>
                <el-select v-model="edit.diagnosis3_normal" size="mini" style="width:480px" @change="shaixuan()" filterable placeholder="请输入或选择病理亚型">
                  <el-option v-for="(item,index) in  this.threechoose" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
              ...
              <div class="type">
                <span>级别:</span>
                <el-select v-model="edit.level" size="mini" style="width:100px" @change="shaixuan()">
                  <el-option v-for="(item,index) in  this.levelList" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
      ...
      if(groupName!='undefined'){
        ...
        .then(res => {
          ...
          if (result.result) {
            ...
            // this.$alert("新建项目名称成功，是否继续加入此分组", "提交结果", {
            //   confirmButtonText: "确定",
            //   confirmButtonText: "确定",
            //   type: "success",
            //   callback: action => {
