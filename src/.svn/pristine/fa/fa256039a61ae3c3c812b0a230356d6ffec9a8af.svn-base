...
export default {
  ...
  methods: {
    ...
    async sure() {                 
      ...
      // let z = "";
      // window.open('http://192.168.75.58/cedar/api/group_report/list.php?&z=1' +'&group_id=' +this.row.id)
      // // const res = await this.axios.get("group_report/list.php", {
      // //   params: { group_id: this.id, z: 1 }
      // // }); 
      // console.log(res);    

      // this.axios.get('http://192.168.75.58/cedar/api/group_report/list.php?&z=1' +'&group_id=' +this.row.id, { //url: 接口地址
