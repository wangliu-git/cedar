        ...
        <div class="eContainer">
          <div>
            ...
            <el-dialog title="上传" width="40%" :visible.sync="uploadTemplateDialog">
             ...
             <el-button class="chu" type="primary" size="mini" @click="chushi()">初始化</el-button>
          </div>         
        </div>
      </div>
    </div>
      ...
      <div class="search" >     
        ...
        <div class="down">
          <el-table          
            ...
            <el-table-column prop="entry_status" label="校验状态" show-overflow-tooltip sortable></el-table-column>
            <el-table-column prop="complete_degree" label="完整度" show-overflow-tooltip  sortable></el-table-column>
  ...
  methods:{
    ...
    async getDataList() {   
      let type = ''
        ...
        this.shuInfo.pagerows = parseInt(res.pagerows)  //每页显示多少条
        // console.log(res)
    },
    // 获取病理号
