        ...
        <el-collapse-item name="2">
          ...
          <div class="baogao">
            ...
            <div class="types">
              <div class="type">
                <span>病理类型:</span>
                <el-select v-model="edit.diagnosis1_Ynormal" clearable size="mini" style="width:180px" @change="shaixuan()" filterable placeholder="请输入或选择病理类型">
                ...
                <el-select
                  name="sample_type"
                  v-model="edit.diagnosis2_Ynormal"
                  size="mini"
                  style="width:300px"
                  @change="shaixuan()"
                  filterable
              ...
              <div class="type">
                <span>病理亚型：</span>
                <el-select v-model="edit.diagnosis3_Ynormal" clearable size="mini" style="width:480px" @change="shaixuan()" filterable placeholder="请输入或选择病理亚型">
                  <el-option v-for="(item,index) in  this.threechoose" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
              </div>
              ...
              <div class="type">
                <span>级别:</span>
                <el-select v-model="edit.Ylevel" size="mini" clearable style="width:100px" @change="shaixuan()">
        ...
        <el-collapse-item name="3">
          ...
          <div class="zhenduan">
            ...
            <div class="types">
              <div class="type">
                <span>病理类型:</span>
                <el-select v-model="edit.diagnosis1_normal" size="mini" style="width:180px" @change="shaixuan()" filterable clearable placeholder="请输入或选择病理类型">
                  <el-option v-for="(item,index) in  this.onechoose" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
                ...
                <el-select
                  name="sample_type"
                  v-model="edit.diagnosis2_normal"
                  size="mini"
                  clearable
                  style="width:300px"
                  @change="shaixuan()"
              ...
              <div class="type">
                <span>病理亚型：</span>
                <el-select v-model="edit.diagnosis3_normal" size="mini" style="width:480px" clearable @change="shaixuan()" filterable placeholder="请输入或选择病理亚型">
                  <el-option v-for="(item,index) in  this.threechoose" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
              ...
              <div class="type">
                <span>级别:</span>
                <el-select v-model="edit.level" clearable size="mini" style="width:100px" @change="shaixuan()">
                  <el-option v-for="(item,index) in  this.levelList" :key="index" :value="item">
                    <span>{{item}}</span>
                  </el-option>
                </el-select>
    ...
    <div class="list">
      <div class="down">
        <el-table
          ...
          <el-table-column label="病理大类" prop="diagnosis1_normal" sortable></el-table-column>
          <el-table-column label="详细类型" prop="diagnosis2_normal" sortable></el-table-column>
        ...
        <div class="mian">
          ...
          <div class="groupList">
            <el-scrollbar >
              ...
              :key="index"
              :value="it.group_name"
              :class="{last:index === groupLists.length-1?'background:red':''}"
          ...
          <div class="name">
            ...
            <el-input placeholder="请输入项目名称..." style="width:380px" v-model.trim="groupName">
              <el-button slot="append" style="background:#DCDCDC;color:black" plain @click="addGroup1(groupName)">保存</el-button>
            </el-input>
          </div>
          <div class="button">
            <!--@click="sure(id)" -->
    ...
    <div class="sick" v-if="luru">
      <div class="container" id="dataImport">
        <div class="form">
          <!-- 按钮-->
          <div class="header">
            <span @click="luru=false">编辑病理信息</span>
            <span>
            ...
            <el-collapse v-model="activeName" class="HZ">
              <el-collapse-item name="1">
                ...
                <div class="HZdown">
                  ...
                  <div class="sickItem">
                    <span>{{showInfo.sex.field_title}}:</span>
                    <el-select placeholder="请选择" name="sex" v-model="editForm.sex" style="width:200px" size="mini">
                      <el-option
                  ...
                  <div class="sickIH">
                    ...
                    <div class="sickItem">
                      ...
                      <el-select
                        ...
                        filterable>
                        <el-option
                          v-for="(item,index) in  this.YoneChoose"
                          :key="index"
                          :value="item.name">
                          <span>{{item.name}}</span>
                        </el-option>
                      ...
                      <el-select
                        ...
                        filterable>
                        <el-option
                          v-for="(item,index) in  this.YtwoChoose"
                          :key="index"
                          :value="item.name">
                          <span>{{item.name}}</span>
                        </el-option>
                    ...
                    <div class="sickItem" v-if="this.editForm.diagnosis2_Ynormal != ''">
                      <span>病理亚型：</span>
                      <el-select                  
                    ...
                    <div class="sickItem">
                      级别：
                      <el-select v-model="editForm.Ygrade" size="mini" style="width:300px" clearable filterable>
                        <el-option v-for="(item,index) in  this.levelList" :key="index" :value="item">
                          <span>{{item}}</span>
                        </el-option>
                      </el-select>
...
export default {
  ...
  methods: {
    ...
    YgetJilian2() {
      console.log(this.editForm.diagnosis2_Ynormal);
      const res = this.axios
        .get("report/jilian.php", {
    ...
    // 获取病理类型3
    getDia3(){
      const res = this.axios.get('report/option.php?table=ly_report&name=diagnosis3_normal').then( res =>{
        console.log(res)
        this.threechoose = res.data.option
      })
    },
    ...
    getsample_type() {
      const res = this.axios
        .get("report/option.php?name=sample_type&table=ly_report")
        .then(res => {
          // console.log(res);
          this.sample_type = res.data.option;
        });
    },
    // 变动筛选
    gaibian() {
    ...
    // 点击添加保存分组
    async addGroup1(groupName,length) {
      ...
      if(groupName!='undefined'){
        ...
        .then(res => {
          ...
          let length = this.groupLists.length;
          this.end = this.groupLists[length-1]
          var result = res.data; //JSON.parse(res.body);
          if (result.result) {
            this.$confirm("新建分组成功，是否将选中数据继续加入此分组？", "提示", {
              confirmButtonText: "确定",
              cancelButtonText: "取消",
              type: "warning",
              center: true
    ...
    async shaixuan() {
      ...
      const { data: res } = await this.axios.get("report/list.php", {
        params: {
          ...
          sample_type:this.edit.sample_type    //标本类型
        }
      });
      console.log(res);
    ...
    async getTableList() {
      const { data: res } = await this.axios.get("report/list.php", {
        params: { page: this.queryInfo.page,pagerows:this.queryInfo.pagerows}
      });
      this.tablelist = res.data;
      // console.log(res.data);
      this.queryInfo.page = parseInt(res.page);
