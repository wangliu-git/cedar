      ...
      <div class="down">
        ...
        <div class="echarts">
          <div class="btns">
            ...
            <el-button   plain @click="drawLineCheck(mark)">生物标记物检测率</el-button >
            <el-button   plain >生物标记物阳性率</el-button >
            <el-button   plain @click="drawLineDiff_day(diff_day)">诊断时长</el-button >
            <el-button  plain >各个病理类型分布</el-button >
            <!--@click="drawLineDia()" -->
          </div>
          <div id="tu"></div>
        </div>
