      ...
      <div class="down">
        ...
        <div class="echarts">
          <div class="btns">
            ...
            <el-button
              :class="{showBtns:address_provShow}"
              plain
              @click="drawLineAddress_prov(address_prov)"
            >居住地</el-button>
            <el-button :class="{showBtns:ageShow}" plain @click="drawLineAge(age)">年龄</el-button>
            <el-button
              :class="{showBtns:birthplaceShow}"
              plain
              @click="drawLineBirthPlace(birthplace)"
            >籍贯</el-button>
            <el-button
              :class="{showBtns:sample_typeShow}"
              plain
              @click="drawLineSample_type(sample_type)"
            >标本类型</el-button>
            <el-button
              :class="{showBtns:sample_locationShow}"
              plain
              @click="drawLineSample_location(sample_location)"
            >取材部位</el-button>
            ...
            <el-button
              :class="{showBtns:diff_dayShow}"
              plain
              @click="drawLineDiff_day(diff_day)"
            >诊断时长</el-button>
            <el-button
              :class="{showBtns:bingShow}"
              v-show="this.type == 0"
              plain
              @click="drawLineDia()"
            >各个病理类型分布</el-button>
  ...
  methods: {   
    ...
    async search() {
      ...
      const res = await this.axios
        .get("group/list.php", { params: { group_name: this.searchname } })
        .then(res => {
          console.log(res);
    ...
    getName() {
      const res = this.axios
        .get("group/list.php", { params: { group_username: this.group_name } })
        .then(res => {
          ...
          toolbox: {
            ...
            feature: {
              ...
              myTool2: {
                ...
                onclick: function() {
                  // setEChart("barWithTool");
                  that.sample_type_barWithTool(param);
                }
              },
              saveAsImage: {
                //工具项-保存为图片
            ...
            feature: {
              ...
              myTool1: {
                ...
                onclick: function() {
                  ...
                  // setEChart_line(myChart, dataEcharts);
                  // setEChart('pieWithTool')
                  that.drawLineSample_type(param)
                }
              },
              magicType: {
                type: ["line", "bar", "stack", "tiled"]
    ...
    Sample_location_pieWithTool(param) {
        let myChart = param.myChart,
          data = param.dataEcharts,
          title = param.title;
        console.log(myChart, data, title);
          ...
          toolbox: {
            ...
            feature: {
              ...
              myTool2: {
               ...
               onclick: function() {
                  // setEChart("barWithTool");
                  that.Sample_location_barWithTool(param);
                }
              },
              saveAsImage: {
                //工具项-保存为图片
    ...
    Sample_location_barWithTool(param) {
        let myChart = param.myChart,
          dataEcharts = param.dataEcharts,
          type = param.type,
          title = param.title;
            ...
            feature: {
              ...
              myTool1: {
                ...
                onclick: function() {
                  ...
                  // setEChart_line(myChart, dataEcharts);
                  // setEChart('pieWithTool')
                  that.drawLineSample_location(param)
                }
              },
              magicType: {
                type: ["line", "bar", "stack", "tiled"]
            ...
            feature: {
              ...
              myTool1: {
                ...
                onclick: function() {
                  ...
                  // setEChart('pieWithTool');
                  that.Diff_day_pieWithTool(param)
                }
              },
              magicType: {
                //多个工具项-动态视图类型切换的选项
          ...
          feature: {
            ...
            myTool1: {
              ...
              icon:
                "path://M522.8 64.1V64h-22v0.1C258.6 69.9 64 268.1 64 511.8c0 247.3 200.5 447.8 447.8 447.8s447.8-200.5 447.8-447.8c0-243.7-194.5-441.9-436.8-447.7z m154.8 55.3c50.7 21.4 96.2 52.2 135.4 91.3 39.1 39.1 69.8 84.7 91.3 135.4 20.8 49.1 32 101.1 33.3 154.7H522.8V86.1c53.6 1.3 105.6 12.5 154.8 33.3z m135.3 693.4c-39.1 39.1-84.7 69.8-135.4 91.3-52.5 22.2-108.2 33.5-165.7 33.5s-113.3-11.3-165.7-33.5c-50.7-21.4-96.2-52.2-135.4-91.3-39.1-39.1-69.8-84.7-91.3-135.4C97.3 625 86 569.2 86 511.8S97.3 398.5 119.5 346c21.4-50.7 52.2-96.2 91.3-135.4 39.1-39.1 84.7-69.8 135.4-91.3 49.1-20.8 101.1-32 154.7-33.3v436.7h436.7c-1.3 53.6-12.5 105.6-33.3 154.7-21.6 50.8-52.3 96.3-91.4 135.4z",
              onclick: function() {
                that.J_Check_pieWithTool(param)
                // alert('myToolHandler1');
                // setEChart_line(myChart, data);
                // setEChart('pieWithTool');
              }
          ...
          feature: {
            ...
            myTool1: {
              ...
              onclick: function() {
                ...
                // setEChart_line(myChart, data);
                // setEChart('pieWithTool');
                that.Y_Check_pieWithTool(param)
              }
            },
            magicType: {
              //多个工具项-动态视图类型切换的选项
    ...
    async drawLineDia() {
      ...
      let datas = res.stat;
      this.Dia_barWithTool({
        myChart: myChart,
        dataEcharts: datas,
        title: "病理类型"
      });
    },
    Dia_barWithTool(param) {
      let myChart = param.myChart,
        dataEcharts = param.dataEcharts,
        type = param.type,
        title = param.title;
