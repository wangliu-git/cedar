      ...
      <div class="down">
        <div class="choose">
          <div>
            ...
            <span>选择分析 ：</span>
            <el-select placeholder="请选择" size="small" v-model="dignosis1" style="width:300px">
          ...
          <div>
            ...
            <span>选择淋巴瘤亚型 ：</span>
            <el-select placeholder="请选择" size="small" v-model="dignosis2" style="width:400px">
        ...
        <div class="echarts">
          <div class="btns">
            ...
            <el-button type="primary" plain @click="drawLineSex()">免疫组化检测率</el-button>
            <el-button type="primary" plain @click="drawLineSex()">免疫组化阳性率</el-button>
      ...
      /**
        ...
        */
        function setEChart_mapWithTool(param) {
            let myChart = param.myChart, data = param.stat, title = param.title;
